...
const string admissible_list_members_strbuf[] = {"E_x_tot","E_y_tot","E_z_tot","E_x_sca","E_y_sca","E_z_sca","E_x_unsca","E_y_unsca","E_z_unsca","intensity_tot","intensity_sca","intensity_unsca"};
...
class ImgDataType
{
	...
	ImgDataType(const Array<double,1>& mylambda):
		...
		choose_smallest_power_of_2(false),

...
/** Cuniverse class **/
/*******************/
bool Cuniverse::IsInside(const double& x, const double& y, const double& z) const
{
	return true;
}

bool Cuniverse::IsAtBoundary(const double& x, const double& y, const double& z, const double& dx) const
{
	return false;
}

double Cuniverse::ratio_of_voxel_inside_volume(const double& x, const double& y, const double& z, const double& dx) const
{
	return 1.0;
}

int Cuniverse::bounding_box_back_cell() const
{
	return LIBSTD_INT_MIN;
}

int Cuniverse::bounding_box_front_cell() const
{
	return LIBSTD_INT_MAX;
}

int Cuniverse::bounding_box_left_cell() const
{
	return LIBSTD_INT_MIN;
}

int Cuniverse::bounding_box_right_cell() const
{
	return LIBSTD_INT_MAX;
}

int Cuniverse::bounding_box_lower_cell() const
{
	return LIBSTD_INT_MIN;
}

int Cuniverse::bounding_box_upper_cell() const
{
	return LIBSTD_INT_MAX;
}

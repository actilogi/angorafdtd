...
////cout << kt_dx << endl;
//exit(-1);
//cout << Green_A_theta_J_x_minus << endl; //V_i_e_minus*cosP;
//cout << Green_A_theta_J_x_plus << endl; //V_i_e_plus*cosP;
//cout << Green_A_theta_J_y_minus << endl; //V_i_e_minus*sinP;
//cout << Green_A_theta_J_y_plus << endl; //V_i_e_plus*sinP;
//cout << Green_A_theta_J_z_minus << endl; //(-V_v_e_minus)*sinT/eps_r;
//cout << Green_A_theta_J_z_plus << endl; //(-V_v_e_plus)*sinT/eps_r;
//cout << Green_A_phi_J_x_minus << endl; //(-V_i_h_minus)*sinP*cosT;
//cout << Green_A_phi_J_x_plus << endl; //(-V_i_h_plus)*sinP*cosT;
//cout << Green_A_phi_J_y_minus << endl; //V_i_h_minus*cosP*cosT;
//cout << Green_A_phi_J_y_plus << endl; //V_i_h_plus*cosP*cosT;
//cout << Green_F_theta_M_x_minus << endl; //V_v_h_minus*cosP*cosT;
//cout << Green_F_theta_M_x_plus << endl; //V_v_h_plus*cosP*cosT;
//cout << Green_F_theta_M_y_minus << endl; //V_v_h_minus*sinP*cosT;
//cout << Green_F_theta_M_y_plus << endl; //V_v_h_plus*sinP*cosT;
//cout << Green_F_theta_M_z_minus << endl; //(-V_i_h_minus)*sinT*cosT/m_r;
//cout << Green_F_theta_M_z_plus << endl; //(-V_i_h_plus)*sinT*cosT/m_r;
//cout << Green_F_phi_M_x_minus << endl; //(-V_v_e_minus)*sinP;
//cout << Green_F_phi_M_x_plus << endl; //(-V_v_e_plus)*sinP;
//cout << Green_F_phi_M_y_minus << endl; //V_v_e_minus*cosP;
//cout << Green_F_phi_M_y_plus << endl; //V_v_e_plus*cosP;
/** Remove later **/
}

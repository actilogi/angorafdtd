...
extern Array<float,1> eps_x,mu_x,cond_e_x;	//this transformer works only for isotropic materials, may generalize later
		...
		: Ctr_pd_ml(MyData,FarFieldFileName,Index)
{
	...
	cond_e_0 = cond_e_x_values_in_layers(number_of_layers-1); /** isotropy assumed! **/	//electrical conductivity of the upper layer;
	cond_e_2 = cond_e_x_values_in_layers(0); /** isotropy assumed! **/	//electrical conductivity of the lower layer;
	...
	{//if the # of layers is 3, the middle layer is a dielectric slab
		...
		{//if the uppermost layer is grounded, then we basically have a 2-layered medium
			...
			epsilon_r_1 = eps_x_values_in_layers(MiddleLayerIndex); /** isotropy assumed! **/	//permittivity of the upper layer
			cond_e_1 = cond_e_x_values_in_layers(MiddleLayerIndex); /** isotropy assumed! **/	//electrical conductivity of the upper layer
			mu_r_1 = mu_x_values_in_layers(MiddleLayerIndex); /** isotropy assumed! **/	//permeability of the upper layer
		...
		{//uppermost layer is not grounded (but the middle layer still could be)
			...
			epsilon_r_1 = eps_x_values_in_layers(MiddleLayerIndex); /** isotropy assumed! **/	//permittivity of the middle layer
			cond_e_1 = cond_e_x_values_in_layers(MiddleLayerIndex); /** isotropy assumed! **/	//electrical conductivity of the middle layer
			mu_r_1 = mu_x_values_in_layers(MiddleLayerIndex); /** isotropy assumed! **/	//permeability of the middle layer
	...
	else if (number_of_layers==2)
	{
		...
		epsilon_r_1 = eps_x_values_in_layers(MiddleLayerIndex); /** isotropy assumed! **/	//permittivity of the upper layer
		cond_e_1 = cond_e_x_values_in_layers(MiddleLayerIndex); /** isotropy assumed! **/	//electrical conductivity of the upper layer
		mu_r_1 = mu_x_values_in_layers(MiddleLayerIndex); /** isotropy assumed! **/	//permittivity of the upper layer
	...
	else if (number_of_layers==1)
	{
		...
		MiddleLayerThickness = 1; //dummy middle layer of thickness 1
		epsilon_r_1 = eps_x_values_in_layers(MiddleLayerIndex); /** isotropy assumed! **/	//permittivity of the homogeneous space
		cond_e_1 = cond_e_x_values_in_layers(MiddleLayerIndex); /** isotropy assumed! **/	//electrical conductivity of the homogeneous space
		mu_r_1 = mu_x_values_in_layers(MiddleLayerIndex); /** isotropy assumed! **/	//permeability of the homogeneous space

...
class TrDataType_td
{
 public:
	 ...
	 bool write_hertzian_dipole_far_field; //is the theoretical field resulting from point sources written into the output?
...
{
 public:
	 Ctr_td(const TrDataType_td& MyData, const string& FileName, const int& Index);	//constructor
 ...
 protected:
	 ...
	 const string FarFieldFileName; //name of the output file

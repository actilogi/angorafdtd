...
class HGBGrazingIncidenceException: public AngoraException
{// the exception class for beams cutting across planar layer interfaces
	public:
	virtual const string getError() const
	{
		return "Error in Chgb (Hermite-Gaussian-beam class): Hermite-Gaussian-beam grazing angle too low. Try larger \"theta\" or wider beam half width.";
	}
};

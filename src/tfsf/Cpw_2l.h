...
class LossyLayerException: public AngoraException
{// the exception class for signaling the presence of a lossy layer
public:
  virtual const string getError() const
  {
    return "Warning: Plane waves cannot be created in a lossy layer with Cpw_2l, using Cpw_ml instead.";
  }
};

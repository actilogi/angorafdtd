...
// Includes the methods that perform the TF/SF corrections associated with a single plane wave in a half space.
...
void Cpw_2l_hs::ApplyCorrectionE(const int& n)
{
...
void Cpw_2l_hs::ApplyCorrectionH(const int& n)
{
...
inline double Cpw_2l_hs::IncidentEx(const int& i, const int& j, const int& k, const int& n)
{
	if (IsFullIntegerComponentInHalfSpace(k))
	{
		//copied from Cpw_fs::IncidentEx
...
inline double Cpw_2l_hs::IncidentEy(const int& i, const int& j, const int& k, const int& n)
{
	if (IsFullIntegerComponentInHalfSpace(k))
	{
		//copied from Cpw_fs::IncidentEy
...
inline double Cpw_2l_hs::IncidentEz(const int& i, const int& j, const int& k, const int& n)
{
	if (IsHalfIntegerComponentInHalfSpace(k))
	{
		//copied from Cpw_fs::IncidentEz
...
inline double Cpw_2l_hs::IncidentHx(const int& i, const int& j, const int& k, const int& n)
{
	if (IsHalfIntegerComponentInHalfSpace(k))
	{
		//copied from Cpw_fs::IncidentHx
...
inline double Cpw_2l_hs::IncidentHy(const int& i, const int& j, const int& k, const int& n)
{
	if (IsHalfIntegerComponentInHalfSpace(k))
	{
		//copied from Cpw_fs::IncidentHy
...
inline double Cpw_2l_hs::IncidentHz(const int& i, const int& j, const int& k, const int& n)
{
	if (IsFullIntegerComponentInHalfSpace(k))
	{
		//copied from Cpw_fs::IncidentHz

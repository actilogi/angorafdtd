...
struct GSMBDataType
{
	...
	double beam_half_width; //half-width of the Gaussian part of the INTENSITY profile (similar to tau in waveforms) (in m)
...
class Cgsmb
{
 ...
 private:
	 ...
	 double aa,bb; //the a and b parameters, where a=1/(4*beam_half_width^2), b=1/(2*correlation_length^2)

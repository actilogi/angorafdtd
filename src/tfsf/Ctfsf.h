...
class Cpw;
//only the declaration of Cflb needed: use forward declaration
class Cflb;
...
class PWDataType;
//only the declaration of FLBDataType needed: use forward declaration
class FLBDataType;
...
class Ctfsf
{
 public:
	 ...
	 //*********** Focused laser-beam source ***************//
	 int AddFocusedLaserBeam(const FLBDataType& MyData);	//adds a focused laser beam
	 int NumberOfFocusedLaserBeams() const
	 {
		 return FocusedLaserBeams.size();
	 };
	 //*********** Focused laser-beam source ***************//
...
//	 };	 //*********** Kohler-beam source ***************//
 ...
 private:
	 ...
	 //*********** Focused laser-beam source ***************//
	 vector<boost::shared_ptr<Cflb> > FocusedLaserBeams;	//array of pointers to focused laser-beam objects
	 //*********** Focused laser-beam source ***************//

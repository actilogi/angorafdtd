...
{
 public:
	 void Initialize(const string& my_logfilename, const int& my_number_of_steps, const time_t& simulation_starting_time);//initializes the estimator (needs to be called right before the time loop)
 ...
 private:
	 ...
	 time_t _simulation_starting_time, estimate;

...
void read_logging_data(Cestimator &Estimator, const Config& fdtdconfig, const time_t& simulation_starting_time)
{
	...
	Estimator.Initialize(fulllogfilename,NSTEPS,simulation_starting_time);
}
